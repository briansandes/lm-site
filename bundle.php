...
fbq('init', '952790900523160');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=952790900523160&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
  <meta charset="UTF-8">
...
<body class="loaded">
  <main>
    ...
    <?php include 'sections/saiba-mais.php'; ?>
    <?php include 'sections/o-ebook.php'; ?>
    <?php include 'sections/product-checkout.php'; ?>
  </main>
