...
<article>
    <section class="section-hero">
        <div class="v-centered-container section-hero_content" id="section-hero__content">
                            ...
                            <div class="content-holder">
                                <div class="v-content">
                                    ...
                                    <div class="cta-holder">
                                        <a href="#saiba-mais" class="btn btn-light cta cta-learn-more">
                                            Ver o conteúdo
                                        </a>
                        ...
                        <div class="col-md-6 col-image">
                            <div class="image-holder">
                                <img src="assets/img/box-ebook-hero.webp" id="section-hero__image"
                                    class="img-fluid section-hero__image"
                                    alt="Finanças Descomplicadas | Lógica Macaquista"
                                    title="Finanças Descomplicadas | Lógica Macaquista"
        ...
        <!-- bottom images -->
        <img src="assets/img/macacolandia-hero.png" class="img-fluid section-hero__bg-bottom"
        loading="eager" fetchpriority="high" />
        <div class="section-hero__bg-bottom-mobile"></div>
        <!-- bottom images -->
    </section>
</article>
<!-- HERO -->